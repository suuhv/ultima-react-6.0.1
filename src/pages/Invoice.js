...
export const Invoice = () => {
	...
	return (
		<div className="layout-invoice-page">
			<Button type="button" label="Print" icon="pi pi-print" onClick={print} className="p-mb-3"></Button>
					...
					<div className="card">
						<div className="p-d-flex p-jc-between">
							...
							<div className="p-d-flex p-flex-column p-ai-end">
								...
								<p className="p-mt-1">9137 3rd Lane California City, CA 93504.</p>
							</div>
						</div>

						<div className="p-p-3">
							<DataTable value={billData} className="p-invoice-datatable-responsive p-pb-3">
								{
							...
							<DataTable value={productData} className="p-invoice-datatable-responsive p-datatable-sm p-py-6">
								{
							...
							<div className="p-grid">
								<div className="p-col-12 p-md-6">
									<Panel header="BANK">
										...
										<div className="p-d-flex p-ai-center p-jc-between p-pt-2 p-py-2">
											<span>IBAN</span>
											<span className="p-text-bold">GB04420235692263866724650931</span>
										</div>
									</Panel>
								</div>
								<div className="p-col-12 p-md-6">
