...
export const Help = () => {
	...
	const basicHeader = <div className="p-d-flex p-ai-center">
	...
	const licencesHeader = <div className="p-d-flex p-ai-center">
		<i className="pi pi-bookmark fs-xlarge p-mr-3 pink-color"></i>
		<div className="p-d-flex p-flex-column">
	...
	const frameworksHeader = <div className="p-d-flex p-ai-center">
		<i className="pi pi-bookmark fs-xlarge p-mr-3 pink-color"></i>
		<div className="p-d-flex p-flex-column">
	...
	return (
		<div className="p-grid layout-help-page">
			<div className="p-col-12">
				<div className="card p-p-0">
					<div className="p-grid p-nogutter">
						<div className="p-col-12 layout-help-page-header">
