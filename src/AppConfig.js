...
const AppConfig = (props) => {
    ...
    return (
        <>
            <Sidebar visible={active} onHide={() => setActive(false)} position={isRTL ? 'left' : 'right'} blockScroll={true} showCloseIcon={false} baseZIndex={1000} className="layout-config p-sidebar-sm fs-small p-p-0">
